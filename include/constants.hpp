...
constexpr int SOURCE_SIZE_X = 4;
constexpr int SOURCE_SIZE_Y = 4;
constexpr int SOURCE_SIZE_Z = 4;
constexpr int SOURCE_Y_MERGIN = 1;
...
constexpr double T_AMBIENT = 150.0;
